...
export const createTenantSchema = z.object({
  body: z.object({
    ...
    parentPhone: z.string().regex(/^[6-9]\d{9}$/, 'Enter valid 10 digit Indian mobile number').or(z.literal('')).nullable().optional(),
    aadhaarLast4: z.string().length(4).or(z.literal('')).nullable().optional(),

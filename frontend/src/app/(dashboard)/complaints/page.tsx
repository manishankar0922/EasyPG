...
import { AlertCircle, Clock, CheckCircle2, Search, Loader2 } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500">Manage tenant requests and facility issues.</p>
        </div>
        
        <div className="flex bg-white/70 backdrop-blur-xl p-1 rounded-2xl border border-white/60 shadow-sm">
                  ...
                  <div className="space-y-2 flex-1">
                    ...
                    {complaint.tenant && (
                      <div className="flex items-center gap-2 text-sm font-medium text-slate-500 pt-2">
                        ...
                        <span>•</span>
                        <span>Room {complaint.tenant.admissions?.[0]?.room?.roomNumber || 'N/A'}</span>
                        <span>•</span>
                  ...
                  <div className="flex items-center gap-2">
                    {complaint.status !== 'OPEN' && (
                      <button 
                        ...
                        className="p-3 rounded-2xl bg-white border border-slate-200 text-slate-600 hover:bg-slate-50 transition tooltip-trigger"
                        title="Mark Open"
                      >
                    ...
                    {complaint.status !== 'IN_PROGRESS' && (
                      <button 
                        ...
                        className="p-3 rounded-2xl bg-amber-50 border border-amber-100 text-amber-600 hover:bg-amber-100 transition tooltip-trigger"
                    ...
                    {complaint.status !== 'RESOLVED' && (
                      <button 
                        ...
                        className="px-6 py-3 rounded-2xl bg-emerald-600 text-white font-bold hover:bg-emerald-700 transition shadow-lg shadow-emerald-600/20 flex items-center gap-2"
                      >
